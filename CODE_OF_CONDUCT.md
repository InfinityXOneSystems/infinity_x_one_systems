...
- Focusing on what is best for the community and organization
...
- Team communications (Slack, email, etc.)
- Company events and meetings
- Public spaces when representing the organization
...
- Contacting the platform team leads
- Sending an email to the designated conduct email address
- Opening a confidential issue (for non-sensitive matters)
...
- Review the Contributor Covenant FAQ at https://www.contributor-covenant.org/faq

---

**Remember**: We're all here to build great things together. Let's treat each other with respect and kindness.
